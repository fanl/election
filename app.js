...
var USER_OR_GROUP_NAME = 'fanl'; // TODO: Insert GitHub username or group name.
...
////////////////////////////////////////////////////////////////////////////////
app.put('/movies/:id',      // TODO: change to suit your URI design.
  function(req, res) {
    ...
    item.type = 'movie'; // TODO: change to the type of item you want
...
////////////////////////////////////////////////////////////////////////////////
app.get('/movies/',         // TODO: change to suit your URI design. 
  function(req, res) {

    var item_type = 'movie'; // TODO: change to the type of item you want.
    ...
    db.getAll(item_type, function(err, items) {
      ...
      // Otherwise, use the returned data to render an HTML page.
        ...
        res.render(
          'list-movies',   // TODO: change to the name of your HTML template.
          { items: items }
        );
      }
    });
...
////////////////////////////////////////////////////////////////////////////////
app.put('/actors/:id', // TODO: change to suit your URI design.
  function(req, res) {
...
////////////////////////////////////////////////////////////////////////////////
app.get('/actors/',          // TODO: change to suit your URI design. 
  function(req, res) {

    var item_type = 'actor'; // TODO: change to the type of item you want.
    ...
    db.getSome(item_type, req.query, function(err, items) {
      ...
      // Otherwise, use the returned data to render an HTML page.
        ...
        res.render(
          'list-actors', // TODO: change to the name of your HTML template.
          { items: items }
        );
      }
    });
...
////////////////////////////////////////////////////////////////////////////////
app.get('/movies/:id',      // TODO: change to suit your URI design.
  function(req, res) {
    ...
    db.getOne(item_type, item_id, function(err, item) {
      ...
      // Otherwise, get the related items associated with this item.
        ...
        var related_type = 'actor'; // TODO: change to type of related item.

        // Set our query to find the items related to the requested item.
        req.query.movie = item_id; // TODO: change `party` to reflect the
        ...
        db.getSome(related_type, req.query, function(err, items) {
          ...
          // Otherwise, use the returned data to render an HTML page.
            ...
            res.render(
            'one-movie', // TODO: change to the name of your HTML template.
...
////////////////////////////////////////////////////////////////////////////////
app.get('/actors/:id',       // TODO: change to suit your URI design.
  function(req, res) {
    ...
    db.getOne(item_type, item_id, function(err, item) {
      ...
      // Otherwise, get the items potentially related to this item.
        ...
        var related_type = 'movie'; // TODO: change to type of related item.
        ...
        db.getAll(related_type, function(err, items) {
          ...
          // Otherwise, use the returned data to render an HTML page.
            ...
            res.render(
              'one-actor', // TODO: change to name of your HTML template.
              { item: item, related_items: items }
            );
          }
        });
